...
namespace MOBA
{
    ...
    public struct CharacterStats
    {
        ...
        public float TotalCritChance => Mathf.Clamp(DamageFormulas.CRIT_CHANCE_BASE + CritChanceBonus, 0f, 1f);
        public float TotalCritMultiplier => DamageFormulas.CRIT_MULTIPLIER + CritDamageBonus;
        ...
        {
            float actualDuration = DamageFormulas.CalculateStunDuration(duration, StunResistance);
            IsStunned = true;
        ...
        public void AddPhysicalResistance(float amount) => PhysicalResistance = Mathf.Min(DamageFormulas.DEFENSE_CAP, PhysicalResistance + amount);
        public void AddTechResistance(float amount) => TechResistance = Mathf.Min(DamageFormulas.TECH_DEFENSE_CAP, TechResistance + amount);
