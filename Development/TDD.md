...
Implement MatchLoopStateMachine – Create the MatchLoopStateMachine MonoBehaviour on the server to manage the lobby, loading, match and results states. Replicate the state via a NetworkVariable.
